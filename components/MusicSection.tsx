...
export function MusicSection() {
  ...
  const videos: Video[] = useMemo(
    () => [
      { id: "dQw4w9WgXcQ", title: "Official Visual", note: "Swap with your newest drop" },
      { id: "FTQbiNvZqaY", title: "Live Performance", note: "Swap with a performance clip" },
      { id: "kJQP7kiw5Fk", title: "Behind the Scenes", note: "Studio / BTS content" },
      { id: "9bZkp7q19f0", title: "Trending Moment", note: "Clip that fans love" },
    ],
    []
  );
      ...
      <Container>
        ...
        <div className="mt-6 grid gap-6 lg:grid-cols-3">
          {[
            ...
            { k: "Apple Music", v: "Add your artist page", hint: "Embed widget or link-out button" },
          ].map((c) => (
