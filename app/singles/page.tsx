...
export default function SinglesPage() {
  ...
  return (
    <Container>
      <div className="py-14">
        <SectionTitle title="Singles" subtitle="Buy & Download" />
        <StoreTabs active="singles" />
                ...
                <div className="flex-1">
                  ...
                  <div className="mt-5 flex items-center justify-between">
                    ...
                    <form action="/api/checkout" method="POST">
                      ...
                      >
                        {paymentsEnabled ? "Buy & Download" : "Coming Soon"}
                      </button>
                    </form>
                  </div>
        ...
        <div className="mt-10 text-sm text-white/60">
          <p>
            ...
            To add more singles later, edit{" "}
            <code className="text-white/80">/lib/catalog.ts</code> and drop the
            audio file into{" "}
            <code className="text-white/80">/private_downloads</code>.
          </p>
        </div>
      </div>
    </Container>
