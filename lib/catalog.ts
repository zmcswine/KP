export type SingleProduct = {
  ...
  previewUrl?: string;  // optional public 30s preview (e.g., /previews/song-preview.mp3)       // filename inside /private_downloads (e.g., kp-single-1.mp3)
  description?: string;
};
...
export const singles: SingleProduct[] = [
  {
    ...
    previewUrl: "/previews/where-da-party-at-preview.mp3",
    description:
...
{
  id: "kp-bundle-1",
  title: "Where Da Party At + KP Tee Bundle",
  priceUsd: 39.99,
  stripePriceId: "price_REPLACE_ME",
  image: "/images/kp-silhouette.png",
  description: "Bundle includes digital single download + KP Logo Tee. (Admin: set Stripe priceId + fulfillment.)",
  options: ["S", "M", "L", "XL", "2XL"],
},
];
